...
Piezas que **no se publican**. No se renderizan a JPG (el script `npm run placas`
solo lee `docs/placas/*.html`, no esta carpeta).

| Pieza | Por qué se archivó | Reemplazo |
|-------|--------------------|-----------|
...
y el reel teaser "mirá este número: 3" de NS 7925 (queda la placa con el dato directo).
