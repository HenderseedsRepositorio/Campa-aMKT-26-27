# Post 01 — Maíz: posicionar antes de comprar

- **Semana:** 2026-W25 · publicación tentativa: 2026-06-16
- **Pilar:** maíz / técnica
- **Formato:** placa simple (1080×1350)
- **Objetivo:** consultas por WhatsApp sobre posicionamiento de maíz en precampaña; posicionar a Henderseeds como asesor, no solo vendedor de bolsas.
- **Pauta:** no
...
## Pieza visual
Placa navy (`#1B2A4A`) con el gancho grande en blanco y "TU lote" en naranja (`#E8761C`).
Foto de fondo opcional: lote de maíz de la zona (oeste bonaerense), con leve oscurecido para que se lea el texto. Logo Henderseeds arriba a la derecha + sello RED.IN Nidera abajo. Un solo mensaje, sin datos numéricos.
...
- Zona y ambientes: `contexto/zona-y-audiencia.md`.
